...
![Camera Zapper dashboard with generic first-run defaults](Documentation/Screenshots/dashboard.png)

> ⚑ **Controlled beta (v1.350).** This is a hands‑on testing build and is **ad‑hoc signed** — on
...
- [User manual](Documentation/USER_MANUAL.md) · [PDF](Documentation/Zebtron-Camera-Zapper-1.350-User-Manual.pdf)
