...
final class AppStore: ObservableObject {
    ...
    func serviceOperationIsRunning(_ id: UUID) -> Bool {
        ...
        return status.hasPrefix("Starting") ||
            status.hasPrefix("Waiting") ||
            status.hasPrefix("Reading") ||
            status.hasPrefix("Testing") ||
            status.range(of: #"^\d+ of \d+"#, options: .regularExpression) != nil
    }
