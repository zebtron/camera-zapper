# Zebtron Camera Zapper 1.348 — Current State and Remaining Work

Updated: September 3, 2026

## Current state

Version 1.348 is built as a controlled macOS beta. The app, source, documentation, screenshots, PDF manual, DMG, application ZIP, and checksums are stored together in this handoff.

Implemented in 1.348:
...
- Version and build identifiers: 1.348 / 1348.
...
1. Install the 1.348 DMG on the M1 16 GB Mac and test wizard completion, relaunch persistence, settings export, and settings import.
...
6. If testing passes, commit and push the final 1.348 sources to GitHub and create the `v1.348` prerelease with DMG, app ZIP, PDF manual, and checksums.
7. Update `zebtron.com/zapper/` using `Documentation/WEBSITE_UPDATE_HANDOFF_1.348.md` and the two 1.348 screenshots.
...
Start with this file, `Documentation/DEVELOPER_HANDOFF.md`, `Documentation/RELEASE_NOTES_1.348.md`, and the repository status. Do not embed or commit OAuth JSON, Flickr credentials, tokens, passwords, Keychain exports, or personal settings backups. Re-run `swift test` and `./build-app.sh` after code changes, then update `dist/SHA256SUMS.txt`.
