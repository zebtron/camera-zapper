# Camera Zapper Website Update Handoff - Version 1.349

## Purpose

Update `zebtron.com/zapper/` for the 1.349 controlled beta. The site source is in the sibling `CameraZapperWebsite` project. This document is the implementation brief for a person or another LLM updating the hosted site.

## Release wording

Use **Version 1.349 controlled beta**. Do not call the current ad-hoc-signed DMG a production-ready public release. Public distribution remains gated on:
...
1. Change every displayed version and bug-report subject from the previous beta to 1.349.
...
- `Zebtron-Camera-Zapper-1.349.dmg`
- `Zebtron-Camera-Zapper-1.349-User-Manual.pdf`
...
- `Documentation/Screenshots/setup-wizard-1.349.png` - clean first-run Welcome screen
- `Documentation/Screenshots/dashboard-1.349.png` - tidy generic dashboard with NAS neutrally Not set up
- `Documentation/Zebtron-Camera-Zapper-1.349-User-Manual.pdf` - downloadable manual

## Verification checklist

- Version is consistently 1.349.
