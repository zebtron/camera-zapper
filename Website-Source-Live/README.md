...
This directory contains the September 2026 snapshot of the live `https://zebtron.com/zapper/` page, updated for Camera Zapper 1.350.

`index.html` is a complete standalone page. It includes a static, fully functional 1.350 release panel and a progressive enhancement that reads the newest non-draft GitHub release from:
...
If GitHub or its API is unavailable, visitors retain the hardcoded 1.350 links and verified checksum. No API key, deployment password, or other credential is embedded.
